      ...
      <div class="dashboard-side-stack">
        ...
        <div class="card">
          ...
          <div class="quick-grid quick-grid--compact">
            ...
            ${renderQuickCard(uiIcon('linechart'), 'linear-gradient(135deg,#0f766e,#22c55e)', 'Looker Studio ITKP', 'Buka dashboard indikator pemanfaatan sistem di Looker Studio.', '', 'https://datastudio.google.com/reporting/d940ac07-c54f-4ff8-af5e-36424698d5a2')}
          </div>
        </div>
      </div>
    </section>
